...
@NgModule({
  declarations: [
    ...
    AdmHomeView, UsuarioView, ProductoView, PedidosView, NotificacionesView, MapaClientsView, ControlEntregasView, ComentariosView,
    AdmDashboardView, VentasComponent, InicioView, TablaUsuarioComponent, ProductFormComponent, PedidosComponent,
    MapaView,ClienteTablaComponent,ClienteFormComponent,
  ],
