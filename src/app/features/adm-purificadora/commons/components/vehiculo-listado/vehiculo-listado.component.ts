...
export class VehiculoListadoComponent {
  ...
  constructor(private fb: FormBuilder, private toast: Toast,private repService: VehiculoService, private render2: Renderer2, private router: ActivatedRoute, private rou: Router) {
  ...
  actualizarVehiculo(id: any) {
    ...
    if (this.vehiculoForm.valid) {
      ...
      this.repService.updateVehiculo(id, VEHICULO)
        .subscribe(response => {
          this.getVehiculos()
          this.visible = false;
